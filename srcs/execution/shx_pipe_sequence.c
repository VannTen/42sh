...
/*   Updated: 2018/03/05 14:44:15 by ble-berr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static pid_t	create_child(int pipe_in, int pipe_out,
		struct s_sh_simple_command *simple_command, t_bool close_pipe_out)
{
	pid_t	father;
...
static int		spawn_pipe(t_lst *sequence, int pipe_in)
{
	...
	{
		father = create_child(pipe_in, pipe_buf[1],
